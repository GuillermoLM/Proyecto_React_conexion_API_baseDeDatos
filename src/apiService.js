...
const generarR = (entity_id, sport_id) => new Promise((resolve, reject) => {
...
const visualizarR = data => new Promise((resolve, reject) => {
...
export default {register, login, datos, generarR, visualizarR}